...
$( "#btnSubmitSignup" ).click(function() {
	...
	var passConf = $("#passConfSignup").val();
	...
	if(email == "") {
  	...
  	if ($.trim(pass) == "") {
  		$("#passError").html("Password is empty");
		// $("#passError").css("display","block");
		$("#passError").fadeTo(1500,1);
		isDataValid = false;
  	}

  	if ($.trim(passConf) == "") {
  		$("#passConfError").html("Confirm password empty");
		// $("#passConfError").css("display","block");
		$("#passConfError").fadeTo(1500,1);
		isDataValid = false;
  	} else if ($.trim(passConf) != $.trim(pass)) {

  		$("#passConfError").html("Check password fiels! Make sure they are right.");
  		$("#passConfError").fadeTo(1500,1);
  		isDataValid = false;
  	}
	...
	function disappear() {
		...
		$("#emailError").fadeTo(1500,0);
		$("#emailError2").fadeTo(1500,0);
		$("#passError").fadeTo(1500,0);
		$("#passConfError").fadeTo(1500,0);
	}
