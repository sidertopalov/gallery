					...
					<div class="photo-form-wrapper clearfix">
						<div class="row">
								...
								<div class="col-md-6 col-sm-6">
									...
									<form action="/admin/promotions/create" method="post" accept="file_extension|image/*" enctype="multipart/form-data" id="addArticle">

											<h3 style="text-decoration: underline;"> Добавяне на нова промоция </h3>
											<hr style="border-color: #e74c3c;">
											...
											Стара цена<input class="form-control" type="number" name="oldPrice" id="oldPrice" min="0" step="any" required /><br>

											Нова цена<input class="form-control" type="number" name="newPrice" id="newPrice" min="0" step="any" required /><br>
